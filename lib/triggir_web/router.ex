defmodule TriggirWeb.Router do
  use TriggirWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {TriggirWeb.Layouts, :root}
  ...
  scope "/api/gitlab", TriggirWeb do
    ...
    post "/webhook", GitlabWebhookController, :run
  end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:triggir, :dev_routes) do
